return {
	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set('n', 'gD', '<cmd>Lspsaga goto_declaration<CR>',
				vim.tbl_extend('force', bufopts, { desc = 'Goto Declaration' }))
			vim.keymap.set('n', 'gt', '<cmd>Lspsaga goto_type_definition<CR>',
				vim.tbl_extend('force', bufopts, { desc = 'Goto Type Definition' }))
			...
			vim.keymap.set('n', '<leader>rnn', '<cmd>Lspsaga rename<CR>',
