...
return {
	...
	-- Mason-Null-LS: Bridges Mason and none-ls (for linters/formatters)
	{
		...
		opts = {
			ensure_installed = {
				'stylua', -- Add for Lua formatting (to address warning if installed)
			},
		...
		opts = function()
			...
			return {
				sources = {
					...
					-- Removed Ruff sources; using Ruff LSP instead
				},
				on_attach = function(client, bufnr)
					-- Auto-format on save (moved to global on_attach below)
				end,
			}
		end,
	},
