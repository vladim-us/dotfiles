...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Useful for getting pretty icons, but requires a NerdFont.
      {
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'nu', 'python', 'rust', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
